# PAL-MEM — Technical Reference

> **For developers and technical readers.**
> Architecture, eval methodology, retrieval internals, trust model, record schema, and integration details. If you want the narrative version first, start with [README.md](./README.md). If you are an agent ingesting this repo, use [README.agent.md](./README.agent.md).
>
> **Other views:** [README.md](./README.md) — general audience | [README.agent.md](./README.agent.md) — agent reference
